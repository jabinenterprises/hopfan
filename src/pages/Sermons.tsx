      ...
      <div className="relative bg-[#111111] pt-32 pb-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-white/60 font-sans text-lg mt-4 max-w-2xl">
            Powerful messages rooted in the Word of God. Watch, listen, and be
            transformed.
          </p>
        </div>
      </div>
              ...
              {/* {filtered.map((sermon) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-[#6B7280] text-sm font-sans mb-4">
                      {sermon.speaker}
                    </p>
          ...
          {filtered.length > 0 && (
            <div className="mt-12 text-center">
              <p className="text-[#6B7280] text-sm font-sans">
                Sermon video and audio links will be connected once the church's
                media source is confirmed.
              </p>
            </div>
          )}
        </div>
