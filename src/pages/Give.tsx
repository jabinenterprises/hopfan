        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-[#6B7280] font-sans text-base leading-relaxed max-w-2xl mx-auto">
              Every gift supports Sunday feeding programs, children's Sunday
              School, youth ministry, women's fellowship, community care for
              orphans and vulnerable children, and "Jesus in the Village"
          ...
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-8 sm:p-12 mb-10">
            <h3 className="font-serif text-2xl font-semibold text-[#111111] mb-8">
              Bank Transfer
            </h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
              <div className="bg-[#F8F6F3] rounded-lg p-5">
                ...
                <p className="font-sans text-sm font-medium text-[#111111] leading-relaxed">
                  Spring Of Miracles Ministry /<br />
              ...
              <div className="bg-[#F8F6F3] rounded-lg p-5">
                ...
                <div className="flex items-center gap-3">
                  <p className="font-mono text-lg font-semibold text-[#111111] tracking-wider">
                    1190282585415
                  </p>
                  <button
                    onClick={copyAccount}
            ...
            {/* <div className="border-t border-gray-100 pt-6">
              <p className="text-[#6B7280] text-xs font-sans uppercase tracking-widest mb-3">
                Other Giving Methods
              </p>
              <p className="text-[#6B7280] font-sans text-sm">
                [Mobile money and additional payment methods to be confirmed by
                church leadership]
              </p>
            </div> */}
            ...
            {/* <div className="mt-8 bg-[#F8F6F3] rounded-lg p-5">
              <p className="text-[#6B7280] text-xs font-sans leading-relaxed">
                ⚠️ <strong className="text-[#111111]">Please verify:</strong>{" "}
                Account details displayed are subject to confirmation by church
                leadership before the public launch of this website. If in
                doubt, please contact the church directly before making a
                transfer.
              </p>
            </div> */}
          </div>
          ...
          <div className="bg-[#A82626] rounded-xl p-8 text-center">
            ...
            <p className="text-white/80 font-sans text-base mb-6">
              Secure online giving will be available once a payment provider is
              connected. For now, please use bank transfer details above.
            </p>
