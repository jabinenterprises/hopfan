...
export default function Prayer() {
  ...
  const Field = ({
    ...
    <div>
      ...
      {children}
      {error && (
        <p className="mt-1.5 text-[#A82626] text-xs font-sans">{error}</p>
      )}
    </div>
  );
    ...
    <main>
      ...
      <div className="relative bg-[#A82626] pt-32 pb-20">
        <div
          ...
          style={{
            backgroundImage:
              "url(https://images.unsplash.com/photo-1504052434569-70ad5836ab65?w=1920&h=600&fit=crop&auto=format)",
          }}
        />
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-white/80 font-sans text-lg mt-4 max-w-2xl">
            As a House of Prayer for All Nations, prayer is not just what we do
            - it is who we are. Share your request and we will stand with you.
          </p>
        </div>
      </div>
          ...
          {state === "success" ? (
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-12 text-center">
              ...
              <p className="text-[#6B7280] font-sans text-sm">
                If you included contact details, we may reach out to you. May
                God meet you right where you are.
              </p>
              <button
                onClick={() => {
                  setForm({
            ...
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-8 sm:p-12">
              ...
              <p className="text-[#6B7280] font-sans text-sm mb-8">
                Share your prayer need. What you share is treated with care and
                respect.
              </p>
              ...
              <form onSubmit={handleSubmit} noValidate className="space-y-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <label
                    ...
                    className="text-sm font-sans text-[#6B7280] leading-relaxed"
                  >
                    Keep my request confidential - shared only with our prayer
                    team
                  </label>
                </div>

                <p className="text-[#6B7280] text-xs font-sans leading-relaxed">
                  Your request is treated with respect and confidentiality. We
