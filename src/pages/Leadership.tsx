      ...
      <div className="relative bg-[#111111] pt-32 pb-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-white/60 font-sans text-lg mt-4">
            Led by faith, shaped by prayer, committed to all nations.
          </p>
        </div>
      </div>
      ...
      <section className="py-20 bg-[#F8F6F3]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {leadership.map((leader) => (
            <div
              key={leader.id}
              className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm max-w-4xl mx-auto"
            >
              <div className="grid grid-cols-1 md:grid-cols-5">
                ...
                <div className="md:col-span-3 p-8 lg:p-12 flex flex-col justify-center">
                  <p className="text-[#A82626] text-xs font-sans uppercase tracking-widest mb-3">
                    {leader.title}
                  </p>
                  <h2 className="font-serif text-3xl lg:text-4xl font-bold text-[#111111] mb-6">
                    {leader.name}
                  </h2>
                  <div className="w-12 h-0.5 bg-[#A82626] mb-8" />
                  <p className="text-[#6B7280] font-sans text-base leading-relaxed mb-6">
                    {leader.bio}
                  </p>
          ...
          {/* <p className="text-center text-[#6B7280] text-sm font-sans mt-12">
            Additional leadership profiles will be added as information is
            confirmed by church officials.
          </p> */}
        </div>
      </section>
    </main>
