    ...
    <main>
      <div className="relative bg-[#111111] pt-32 pb-20">
        <div
          ...
          style={{ backgroundImage: "url(/images/children-ministry2.jpeg)" }}
        />
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-white/60 font-sans text-lg mt-4 max-w-2xl">
            Serving every generation through prayer, care, education, outreach
            and fellowship.
          </p>
        </div>
      </div>
      ...
      <section className="py-20 bg-[#F8F6F3]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="pt-4 border-t border-gray-100 space-y-1.5">
                    {ministry.audience !== "All" && (
                      <p className="text-xs font-sans text-[#6B7280]">
                        <span className="text-[#111111] font-medium">For:</span>{" "}
                        {ministry.audience}
                      </p>
                    )}
                    <p className="text-xs font-sans text-[#6B7280]">
                      <span className="text-[#111111] font-medium">Meets:</span>{" "}
          ...
          <div className="mt-16 text-center bg-[#A82626] rounded-lg p-10">
            <p className="text-white/70 text-xs font-sans uppercase tracking-widest mb-3">
              Get Involved
            </p>
            ...
            <p className="text-white/80 font-sans max-w-xl mx-auto mb-8">
              Whether you want to serve, learn, or simply belong - our
              ministries are open to you. Reach out and take the next step.
            </p>
            <a
