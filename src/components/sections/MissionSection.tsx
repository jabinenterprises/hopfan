  ...
  return (
    <section className="relative py-24 lg:py-32 overflow-hidden bg-[#111111]">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=1920&h=800&fit=crop&auto=format)",
        }}
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-[#A82626] text-xs font-sans uppercase tracking-[0.25em] mb-8">
            Our Mission
          </p>
          ...
          <h2 className="font-serif text-5xl sm:text-6xl lg:text-7xl font-bold text-white leading-tight mb-8">
            All Flesh to See
            <br />
            <span className="text-[#A82626]">the Salvation</span>
            <br />
            of the Lord
          </h2>
          ...
          <p className="text-white/60 font-sans text-base sm:text-lg leading-relaxed max-w-2xl mx-auto mb-12">
            This is the heartbeat of everything we do - prayer, worship,
            outreach, community service, and the preaching of the gospel. Every
            nation. Every person. All flesh.
          </p>
