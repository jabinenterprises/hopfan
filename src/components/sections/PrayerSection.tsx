  ...
  return (
    <section className="relative py-24 lg:py-32 overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(https://images.unsplash.com/photo-1504052434569-70ad5836ab65?w=1920&h=800&fit=crop&auto=format)",
        }}
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl">
          ...
          <p className="text-white/80 font-sans text-base sm:text-lg leading-relaxed mb-10">
            Prayer is not just what we do - it is who we are. As a House of
            Prayer for All Nations, we stand with you in every season. Submit a
            prayer request and our team will pray with you and for you.
          </p>
