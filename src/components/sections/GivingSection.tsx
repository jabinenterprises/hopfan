        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-white/70 font-sans text-base leading-relaxed mb-8">
              ...
              Every gift is an act of faith.
            </p>
            <p className="text-white/50 font-sans text-sm leading-relaxed mb-10 italic">
              "Jesus in the Village," Sunday feeding programs, orphan support,
              and the kindergarten that serves the community - your giving makes
              it possible.
            </p>
            ...
            <div className="space-y-6">
              ...
              <div className="border-b border-white/10 pb-6">
                ...
                <div className="flex items-center gap-3">
                  <p className="text-white/80 text-sm font-sans font-mono tracking-wider">
                    1190282585415
                  </p>
                </div>
              </div>
