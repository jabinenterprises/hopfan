      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-stretch">
          ...
          <div className="relative overflow-hidden rounded-lg bg-[#F8F6F3] p-10 lg:p-14 flex flex-col justify-between">
            ...
            />
            <div>
              <p className="text-[#A82626] text-xs font-sans uppercase tracking-[0.2em] mb-6">
            ...
            <div className="mt-10 font-sans text-sm text-[#6B7280] leading-relaxed">
              This Scripture gives our church its name and shapes our identity.
              We are built as a house of prayer - open to all nations, all
              peoples, all who seek God.
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-lg bg-[#A82626] p-10 lg:p-14 flex flex-col justify-between">
            <div>
              <p className="text-white/60 text-xs font-sans uppercase tracking-[0.2em] mb-6">
                Our Living Promise
              </p>
            ...
            <div className="mt-10 font-sans text-sm text-white/70 leading-relaxed">
              More than a location - a promise. Where we gather, God is present.
              The Lord is here, among his people, in prayer, in worship, in
              community.
            </div>
          </div>
        </div>
